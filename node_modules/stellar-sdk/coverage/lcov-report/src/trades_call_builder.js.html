...
<div class='wrapper'>
  <div class='pad1'>
    ...
    <div class='clearfix'>
      ...
      <div class='fl pad1y'>
        <span class="strong">4 statements, 12 branches</span>
...
export class TradesCallBuilder extends CallBuilder {
    constructor(serverUrl) <span class="branch-1 cbranch-no" title="branch not covered" >{</span>
        super(serverUrl);
...
<span class="cstat-no" title="statement not covered" >            t</span>his.url.addQuery("base_asset_type", base.getAssetType());
<span class="cstat-no" title="statement not covered" >            t</span>his.url.addQuery("base_asset_code", base.getCode());
<span class="cstat-no" title="statement not covered" >            t</span>his.url.addQuery("base_asset_issuer", base.getIssuer());
        } else {
...
<span class="cstat-no" title="statement not covered" >            t</span>his.url.addQuery("counter_asset_type", 'native');
        }
        return this;
    }
&nbsp;
