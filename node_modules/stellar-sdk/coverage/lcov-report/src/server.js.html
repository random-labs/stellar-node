  ...
  <div class='pad1'>
    ...
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>79/80</span>
      </div>
      <div class='fl pad1y space-right2'>
...
228
229
230</td><td class="line-coverage quiet"><span class="cline-any cline-yes">1×</span>
...
<span class="cstat-no" title="statement not covered" >                    r</span>eturn Promise.reject(new BadResponseError(`Transaction submission failed. Server responded: ${response.status} ${response.statusText}`, response.data));
                }
            });
    }
&nbsp;
