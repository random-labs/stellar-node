...
31
32
33</td><td class="line-coverage quiet"><span class="cline-any cline-yes">1×</span>
...
export class OrderbookCallBuilder extends CallBuilder {
    constructor(serverUrl, selling, buying) <span class="branch-1 cbranch-no" title="branch not covered" >{</span>
        super(serverUrl);
