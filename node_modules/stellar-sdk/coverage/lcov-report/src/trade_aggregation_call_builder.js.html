...
export class TradeAggregationCallBuilder extends CallBuilder {
  constructor (serverUrl, base, counter, start_time, end_time, resolution)<span class="branch-1 cbranch-no" title="branch not covered" >{</span>
    super(serverUrl);
...
<span class="cstat-no" title="statement not covered" >        t</span>hrow new BadRequestError("Invalid time bounds", [start_time, end_time]);
    }else{
...
<span class="cstat-no" title="statement not covered" >        t</span>hrow new BadRequestError("Invalid resolution", resolution);
    }else{
