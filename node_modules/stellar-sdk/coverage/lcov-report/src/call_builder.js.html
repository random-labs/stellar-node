  ...
  <div class='pad1'>
    ...
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">89.52% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>111/124</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        <span class="strong">86.46% </span>
        <span class="quiet">Lines</span>
        <span class='fraction'>83/96</span>
      </div>
      <div class='fl pad1y'>
...
244
245
246</td><td class="line-coverage quiet"><span class="cline-any cline-yes">1×</span>
...
v</span>ar EventSource = (typeof window === 'undefined') ? require('eventsource') : <span class="branch-1 cbranch-no" title="branch not covered" >window.EventSource;
&nbsp;
/**
...
export class CallBuilder {
  constructor(serverUrl) {
    this.url = serverUrl;
    this.filter = [];
    t</span>his.originalSegments = this.url.segment() || <span class="branch-1 cbranch-no" title="branch not covered" >[];
  }
&nbsp;
  /**
   * @private
...
<span class="cstat-no" title="statement not covered" >        e</span>s.close();
<span class="cstat-no" title="statement not covered" >        e</span>s = createEventSource();
...
<span class="cstat-no" title="statement not covered" >          o</span>ptions.onerror(err);
<span class="cstat-no" title="statement not covered" >          o</span>ptions.onerror('EventSource not supported');
        }
...
&nbsp;
      es.onmessage = message =&gt; {
        v</span>ar result = message.data ? this._parseRecord(JSON.parse(message.data)) : <span class="branch-1 cbranch-no" title="branch not covered" >message;
...
<span class="cstat-no" title="statement not covered" >        if (options.onerror) {</span>
<span class="cstat-no" title="statement not covered" >          o</span>ptions.onerror(error);
        }
      };
&nbsp;
      return es;
...
<span class="cstat-no" title="statement not covered" >        u</span>ri = URI(link.href);
      }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        r</span>eturn this._sendNormalRequest(URI(json._links.prev.href))
          .then(<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >r</span></span> =&gt; this._toCollectionPage(r));
      }
    };
  }
&nbsp;
  ...
  _handleNetworkError(error) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (error.response &amp;&amp; error.response.status) {
...
<span class="cstat-no" title="statement not covered" >          r</span>eturn Promise.reject(new NetworkError(error.response.statusText, error.response.data));
      }
    } else {
<span class="cstat-no" title="statement not covered" >      r</span>eturn Promise.reject(new Error(error));
    }
  }
&nbsp;
  /**
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Thu Jul 19 2018 13:38:02 GMT+0000 (UTC)
</div>
</div>
