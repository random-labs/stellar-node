...
<div class='wrapper'>
  <div class='pad1'>
    ...
    <div class='clearfix'>
      ...
      <div class='fl pad1y'>
        <span class="strong">3 statements, 9 branches</span>
...
export class PathCallBuilder extends CallBuilder {
    constructor(serverUrl, source, destination, destinationAsset, destinationAmount) <span class="branch-1 cbranch-no" title="branch not covered" >{</span>
        super(serverUrl);
...
<span class="cstat-no" title="statement not covered" >            t</span>his.url.addQuery('destination_asset_type', 'native');
        }
    }
}
&nbsp;</pre></td></tr>
